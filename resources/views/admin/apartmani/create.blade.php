...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        {{-- POPRAVLJENO: Putanja je prebačena na direktan i siguran URL za listu smeštaja kako ne bi bacalo RouteNotFound izuzetak --}}
    ...
    <div style="background:white; border:1.5px solid #f1f5f9; border-radius:16px; padding:32px; max-width:700px;">
        {{-- POPRAVLJENO: Akcija forme prebačena na direktan URL za čuvanje podataka --}}
        <form action="{{ url('admin/smestaji') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="file" name="gallery_images[]" accept="image/*" multiple
                       style="width:100%; border:1.5px solid #e2e8f0; border-radius:8px; padding:10px 14px; font-size:14px; outline:none;">
                <small style="color:#94a3b8; font-size:12px; display:block; margin-top:4px;">Možete izabrati više slika odjednom (držite CTRL ili Shift prilikom odabira slika).</small>
            </div>
